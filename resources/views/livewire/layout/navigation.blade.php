...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex flex-wrap">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-admin.nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate>
                        {{ __('Dashboard') }}
                    </x-admin.nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-admin.nav-link :href="route('admin.projects.index')" :active="request()->routeIs('admin.projects.index')" wire:navigate>
                        {{ __('Projects') }}
                    </x-admin.nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-admin.dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-admin.dropdown-link :href="route('profile')" wire:navigate>
                            {{ __('Profile') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="space-y-1">
            <x-admin.responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate>
                {{ __('Dashboard') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <x-admin.responsive-nav-link :href="route('profile')" wire:navigate>
                    {{ __('Profile') }}
                </x-admin.responsive-nav-link>
