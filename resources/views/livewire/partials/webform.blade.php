<div>
    ...
    @if ($show)
        <div wire:transition class="fixed inset-0 z-30 flex items-center justify-center bg-black/50">
            <form x-data class="max-w-md mx-auto bg-white" wire:submit.prevent="submitForm" @click.away=$dispatch('close-form')>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model.defer="email" type="email" name="floating_email" id="floating_email"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <button wire:click="hidenWebform" wire:loading.attr="disabled" type="button"
