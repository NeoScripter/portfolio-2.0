...
<form class="w-full max-w-sm sm:ml-auto md:w-100 shrink-0" method="GET"
    onsubmit="event.preventDefault(); window.location.href = {{ $action }} + encodeURIComponent(this.search.value);">
    <label for="default-search" class="text-sm font-medium text-gray-900 sr-only dark:text-white">Поиск</label>
    <div class="relative">
