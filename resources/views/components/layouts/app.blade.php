...
<body class="font-serif antialiased">
    <div class="max-w-screen-xl min-h-screen mx-auto overflow-x-hidden">
        ...
        <header
            ...
            <img src="{{ asset('images/partials/logo.webp') }}" alt=""
            ...
            <div class="flex-1 hidden gap-3 px-4 py-2 ml-4 border-l border-gray-400 sm:flex sm:justify-between">
                <div class="pl-8">
                    ...
                    <nav>
                        <ul class="flex items-center gap-6 text-sm font-bold tracking-widest uppercase md:gap-10">
                            ...
                            <li><a href=""
                                    class="transition-colors duration-300 hover:text-gray-500">Portfolio</a></li>
                            <li><a href=""
                                    class="transition-colors duration-300 hover:text-gray-500">Services</a></li>
                ...
                <div class="flex-shrink-0">
                        <div class="relative pr-1 ml-auto lang-toggle w-max group hover:after:text-gray-400 after:transition-colors ">
                            <select name="" id="" class="p-0 mb-2 bg-black font-main select-field appearance-none tracking-[2px] text-xs font-regular border-none w-20 block cursor-pointer transition-colors group-hover:text-gray-400 outline-none shadow-none focus-visible:text-gray-400">
            ...
            <button class="w-8 h-8 group sm:hidden">
                ...
                <span class="block w-full h-0.5 mt-1.5 bg-black group-hover:bg-gray-500"></span>
                <span
                    class="relative font-bold group-hover:text-gray-500 tracking-[2px] -top-1 font-main text-xxxs">MENU</span>
            </button>
        </header>
